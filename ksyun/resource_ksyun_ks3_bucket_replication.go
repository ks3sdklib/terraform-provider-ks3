...
func retrieveReplicationRules(client *connectivity.KsyunClient, bucket string) (*ReplicationConfiguration, error) {
...
func isReplicationRuleExist(client *connectivity.KsyunClient, bucket string, ruleId string) (bool, error) {
	// Read the replication Progress by rule id
	_, err := client.WithKs3Client(func(ks3Client *ks3.Client) (interface{}, error) {
		return ks3Client.GetBucketReplicationProgress(bucket, ruleId)
	})
...
func retrieveReplicationRuleProgress(client *connectivity.KsyunClient, bucket string, ruleId string) (ReplicationProgress, error) {
	...
	if err := xml.Unmarshal(body, &rp); err != nil {
		return rp, WrapErrorf(err, DefaultErrorMsg, bucket, "Unmarshal XML", KsyunKs3GoSdk)
	}
...
func resourceAlicloudOssBucketReplicationCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, bucket, "Marshal to XML", KsyunKs3GoSdk)
	}
	...
	raw, err := client.WithKs3Client(func(ks3Client *ks3.Client) (interface{}, error) {
		requestInfo = ks3Client
		return nil, ks3Client.PutBucketReplication(bucket, xmlString)
	})
	if err != nil {
		if !IsExpectedErrors(err, []string{"BucketReplicationAlreadyExist"}) {
			return WrapErrorf(err, DefaultErrorMsg, bucket, "PutBucketReplication", KsyunKs3GoSdk)
		}
...
func resourceAlicloudOssBucketReplicationDelete(d *schema.ResourceData, meta interface{}) error {
	...
	raw, err := client.WithKs3Client(func(ks3Client *ks3.Client) (interface{}, error) {
		requestInfo = ks3Client
		return nil, ks3Client.DeleteBucketReplication(bucket, ruleId)
	})
	...
	if err != nil {
		return WrapErrorf(err, DefaultErrorMsg, bucket, "DeleteBucketReplication", KsyunKs3GoSdk)
	}
