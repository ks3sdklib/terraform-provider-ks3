...
func TestAccAlicloudOssBucketsDataSource_basic(t *testing.T) {
	...
	var existOssBucketsMapFunc = func(rand int) map[string]string {
		return map[string]string{
			...
			"buckets.0.cors_rules.1.expose_headers.0":  "x-ks3-test",
			...
			"buckets.0.policy": "{\"Statement\":[{\"Action\":[\"ks3:*\"],\"Effect\":\"Allow\",\"Resource\":[\"acs:ks3:*:*:*\"]}],\"Version\":\"1\"}",
	...
	var ks3BucketsCheckInfo = dataSourceAttr{
		resourceId:   resourceId,
		existMapFunc: existOssBucketsMapFunc,
		fakeMapFunc:  fakeOssBucketsMapFunc,
	}

	ks3BucketsCheckInfo.dataSourceTestCheck(t, rand, nameRegexConf)
}
...
func TestAccAlicloudOssBucketsDataSource_sserule(t *testing.T) {
	...
	ks3BucketsCheckInfo.dataSourceTestCheckWithPreCheck(t, rand, preCheck, nameRegexConf)
}
