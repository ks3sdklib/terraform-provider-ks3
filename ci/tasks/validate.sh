...
TERRAFORM_SOURCE_PATH=$CURRENT_PATH/terraform-provider-ks3
...
TF_NEXT_PROVIDER=$CURRENT_PATH/next-provider/terraform-provider-ks3
...
TF_PLUGIN_FILE_NAME="terraform-provider-ks3_${plugin_file_version}"
